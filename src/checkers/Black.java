...
public class Black {
	...
	/**
	 * Returns a vector of all possible moves which Black can make at the state of
	 * the game given by board.
	 * 
	...
	private static Move ForwardLeftForBlack(int r, int c, Board board) {
		...
		if (r >= 1 && c < Board.cols - 1 && board.cell[r - 1][c + 1] == CellEntry.empty
	...
	private static Move ForwardRightForBlack(int r, int c, Board board) {
		...
		if (r >= 1 && c >= 1 && board.cell[r - 1][c - 1] == CellEntry.empty) {
	...
	private static Move BackwardLeftForBlack(int r, int c, Board board) {
		...
		if (r < Board.rows - 1 && c < Board.cols - 1 && board.cell[r + 1][c + 1] == CellEntry.empty) {
	...
	private static Move BackwardRightForBlack(int r, int c, Board board) {
		...
		if (r < Board.rows - 1 && c >= 1 && board.cell[r + 1][c - 1].equals(CellEntry.empty)) {
